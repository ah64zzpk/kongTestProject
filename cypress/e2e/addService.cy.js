...
describe('Kong Manage Service Page add service', () => {
  const serviceOverviewPage = new ServiceOverviewPage();
  const serviceAddPage = new ServiceAddPage();

    beforeEach(() => {
      // Visit the page containing the table and the delete action
      serviceOverviewPage.visitGatewayPage();
      // Delete all services before each test
      serviceOverviewPage.deleteAllServices();
    });
